function HelpSection() {
  return (
    <div className="flex flex-col bg-gray-600 md:mx-52 mx-2 opacity-25">
      ...
      <p className="my-1">Click on individual pieces on the board to reset them, or click on <b>Clear</b> or refresh to reset page</p>
