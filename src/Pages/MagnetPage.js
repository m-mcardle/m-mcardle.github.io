          ...
          <div className='bg-white xl:mx-48 md:ml-32 border-4 border-neutral-900 min-h-screen'>
            ...
            <div className='px-5'>
              <div ref={intro} className='space-y-2'>
                ...
                <p>
                  My name is Matthew McArdle and I am a third year Software Engineering Student at the University of Guelph. 
                  I have just completed my very first co-op placement at the amazing Waterloo company <b>Magnet Forensics</b>.
                  On this page I will specifically be going into great detail about my amazing experience during my time there.
                </p>
                <p>
                  I hope by the end of this you get a good idea about all the awesome experiences I got during my time at Magnet, and are as blown away as I am about how many different things I got the chance to learn.
                </p>
              </div>
              <hr/>
                ...
                <div className='flex flex-row my-4 w-full'>
                  <div className='flex flex-col w-full'>
                    ...
                    >
                      ...
                      I ended up accepting that this goal would not be accomplished in leu of the issues I just mentioned. 
                    ...
                    <GoalSection
                      title="Run BVT"
                      description="Take on the responsibility of being a Build Verification Testing champion or co-champion" 
            ...
            <hr/>
            <div ref={kudos} className="flex flex-row my-5">
              <div className="flex-col">
                <div className='flex flex-row my-4'>
                  <div className='flex flex-col m-auto'>
